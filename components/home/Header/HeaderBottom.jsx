  ...
  return (
    <div className="w-full bg-f5 relative">
      <div className="max-w-container">
        <Flex className="flex flex--ccol flex--row itemss-start lg:items-center justify-between w-full pxx-4 pt-4 pt-00 pb-4 lg:pb-0 h-full lg:h-24">
          <div
          ...
          <div className="relative  searchs w-full lg:w-600 h-50 text-base text-primary bg-white flex items-center gap-2 justify-between px-6 rounded-xl">
            <input
                  ...
                  filteredProducts.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-xs text-black">{item.des}</p>
                        <p className="text-sm text-black">
                          Price:{" "}
                          <span className="text-primary text-black font-semibold">
                            ${item.price}
                          </span>
                        </p>
                      </div>
