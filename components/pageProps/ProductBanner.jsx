...
const ProductBanner = ({ itemsPerPageFromBanner }) => {
  ...
  return (
    <div className="w-10000 flex flex-col md:flex-row md:items-center justify-betweenn">
      {/* =========================================================
      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        <div className="flex items-center gap-2 text-base text-[#767676] relative">
          ...
          <select
            ...
            id="countries"
            className="w-32 md:w-52 border border-[1px] border-gray-200 py-1 px-4 cursor-pointer text-primeColor text-base block dark:placeholder-gray-400 appearance-none focus-within:outline-none focus-visible:border-primeColor"
          >
          ...
          <span className="absolute text-color textt-sm right-2 md:right-4 top-2.5">
            <GoTriangleDown  className=" color"/>
          </span>
        </div>
        <div className="flex items-center gap-2 text-[#767676] relative">
          ...
          <span className="absolute  textt-sm right-3 top-2.5">
            <GoTriangleDown className="color" />
          </span>
        </div>
      </div>
